...
zooAnimals.forEach(function(index, item){
  animalNames.push("Name: " + zooAnimals[item].animal_name + ", Scientific: " + zooAnimals[item].scientific_name);
...
lowerCase = zooAnimals.map(function(index, item){
  return zooAnimals[item].animal_name.toLowerCase();
});
